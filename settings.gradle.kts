...
include("common-adapters")
include("analytics:analytics-adapters")
include("analytics:analytics-application")
include("analytics:analytics-domain")
include("analytics:analytics-application-impl")